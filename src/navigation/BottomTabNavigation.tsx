    ...
    tabBarIcon: ({ focused, color, size }: { focused: boolean; color: string; size: number }) => {
        ...
        switch (route.name) {
            ...
            case APP_ROUTES.BOTTOM.NOTIFICATION:
                iconName = focused ? Images.NotificationDarkIcon : Images.NotificationIcon;
                break;
            default:
        ...
        return (
            <>
                <Image source={iconName} tintColor={route.name !== APP_ROUTES.BOTTOM.RESUMES ? iconTintColor : undefined} style={styles.bottomTabIcon} />
            </>
        )
    }
})
const MyTabs = () => {
    return (
        <Tab.Navigator screenOptions={screenOptions}>
            ...
            />
            <Tab.Screen
                name={APP_ROUTES.BOTTOM.RESUMES}
